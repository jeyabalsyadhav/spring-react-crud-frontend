...
export default class CreateEmployeeComponent extends Component {
    constructor(props) {
        ...
        this.saveOrUpdataEmployee = this.saveOrUpdataEmployee.bind(this);
    }
                        ...
                        <div className='card col-md-6 offset-md-3 offset-md-3'>
                            ...
                            <div className='card-body'>
                                <form action="">
                                    ...
                                    <button className='btn btn-success' onClick={this.saveOrUpdataEmployee}>Save</button>
